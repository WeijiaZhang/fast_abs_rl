...
def decode(save_path, abs_dir, ext_dir, split, batch_size,
    ...
    extractor = Extractor(ext_dir, cuda=cuda)
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(
        description='run decoding of the pretrained model (ML)')
    parser.add_argument('--path', required=True, help='path to store/eval')
    parser.add_argument('--abs_dir', required=True,
                        help='root of the abstractor model')
